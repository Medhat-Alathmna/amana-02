...
export default function BusMap() {
  ...
  const busIcon = useMemo(
    () =>
      new L.Icon({
        iconUrl:
          'https://cdn-icons-png.flaticon.com/512/741/741411.png',
        iconSize: [32, 32],
        iconAnchor: [16, 32],
      }),
    [],
        ...
        >
          ...
          {selectedBus && (
            <>
              ...
              <Polyline
                positions={selectedBus.bus_stops.map(
